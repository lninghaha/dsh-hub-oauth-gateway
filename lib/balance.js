...
const SCHEMES = {
	...
	dashscope: {
		...
		parse: (json) => {
			...
			const remaining = typeof data?.available_balance === "number" ? data.available_balance
				: typeof data?.balance === "number" ? data.balance : void 0;
	...
	siliconflow: {
		...
		parse: (json) => {
			const data = json?.data ?? json;
			const remaining = typeof data?.balance === "number" ? data.balance
				: typeof data?.available_balance === "number" ? data.available_balance : void 0;
			const total = typeof data?.total_balance === "number" ? data.total_balance : void 0;
