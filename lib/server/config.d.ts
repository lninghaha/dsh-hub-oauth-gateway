...
export declare const RuntimeConfigSchema: z.ZodPreprocess<z.ZodPipe<z.ZodObject<{
    ...
    codingOAuth: z.ZodDefault<z.ZodObject<{
        ...
        retryPolicy: z.ZodOptional<z.ZodPipe<z.ZodUnknown, z.ZodTransform<import("@deepseek-ai/dsh-llm").NormalRetryPolicyConfig | import("@deepseek-ai/dsh-llm").AlwaysRetryPolicyConfig, unknown>>>;
