...
export declare function handleOpenAiChatCompletions(req: IncomingMessage, res: ServerResponse, backend: GatewayBackend, parsed?: Record<string, unknown>): Promise<void>;
