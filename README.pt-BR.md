...
- **Compatibilidade opt-in com OpenCode Go** — o gateway pode fazer proxy de chat completions para o OpenCode Go e injetar `x-opencode-session` sticky (evita `MissingSessionID` quando o cliente omite afinidade de sessão); desligado por padrão.
...
Pesquisa de produto: [`docs/research/usage-analytics-landscape.md`](https://github.com/lninghaha/dsh-hub-oauth-gateway/blob/main/docs/research/usage-analytics-landscape.md). Arquitetura: [`docs/02-architecture.md`](docs/02-architecture.md).
...
# `dsh web` é o alias oficial da CLI, não um nome de serviço. Use o gerenciador de processos realmente configurado.
```
...
- DeepSeek Harness Web, verificado com `@deepseek-ai/dsh 0.1.1-rc.2`
