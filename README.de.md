...
**v1.13.3** · früher `dsh-usage-stats`
...
<p align="center">
  <img src="docs/images/en/usage-center-hud.png" alt="Schwebendes Nutzungs-HUD auf der DSH-Shell" width="760" />
  <br />
...
<p align="center">
  <img src="docs/images/en/usage-center-dashboard.png" alt="Vollständiges Usage-Center-Dashboard" width="760" />
  <br />
  <em>Vollständiges Dashboard — Bereiche, Tabs, Aktualisieren und CSV-/JSON-Export</em>
</p>

<p align="center">
  <img src="docs/images/en/usage-center-settings.png" alt="Einstellungen → Usage Center" width="760" />
  <br />
...
- DeepSeek Harness Web, verifiziert mit `@deepseek-ai/dsh 0.1.1-rc.2`
...
**Settings → Usage Center** hat sechs Top-Tabs: **Display**, **Accounts**, **Gateway**, **Capabilities**, **Providers** und **Fees**. Angemeldete Provider-Karten eingeklappt bis expandiert. Jede Providers-Karte pflegt ihre Auth direkt — API Key speichern/löschen, Copilot device auth, Aktualisierung pro Provider — OAuth-Karten verlinken direkt zu Accounts-Anmeldung/-Import.
